    ...
    <div className="space-y-6">
      ...
      <div className={`p-4 rounded-lg ${getStatusColor(selectedPurchase.status)}`}>
        <div className="flex items-center gap-3">
          ...
          <span className="font-medium">Status: {selectedPurchase.status}</span>
        </div>
      </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-medium text-gray-900 dark:text-white">
                ${selectedPurchase.totalAmount?.toFixed(2) || '0.00'}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        {selectedPurchase.actualDelivery && (
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4">
            <p className="text-sm text-gray-500 dark:text-gray-400">Actual Delivery</p>
            <p className="font-medium text-gray-900 dark:text-white">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
          <h3 className="text-lg font-medium text-gray-900 dark:text-white">Purchase Items</h3>
        </div>
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
              ...
              <tr className="bg-gray-50 dark:bg-gray-900/50 font-medium">
                ...
                <td className="px-6 py-4 text-right text-gray-900 dark:text-white">
                  ${selectedPurchase.subtotal?.toFixed(2) || '0.00'}
                </td>
              </tr>
              <tr className="bg-gray-50 dark:bg-gray-900/50 font-medium">
                <td colSpan="3" className="px-6 py-4 text-right text-gray-900 dark:text-white">
                ...
                <td className="px-6 py-4 text-right text-gray-900 dark:text-white">
                  ${selectedPurchase.tax?.toFixed(2) || '0.00'}
                </td>
              </tr>
